        ...
        <div class="donate-option">
          ...
          <div class="donate-option-description container">
            ...
            <p>
              ...
              you prefer to make your donation over the phone please call
        ...
        <div class="donate-option">
          ...
          <div class="donate-option-description container">
            ...
            <p>
              ...
              on a monthly basis. Your ongoing commitment to mentoring will impact
              the girls we serve today and tomorrow. Set up your monthly donation
        ...
        <div class="donate-option">
          ...
          <div class="donate-option-description container">
            ...
            <p>
              ...
              Lower Mainland. By designating your United Way gift to Big Sisters,
        ...
        <div class="donate-option">
          ...
          <div class="donate-option-description container">
            ...
            <p>
              ...
              member with a gift in their honour. If a loved one has recently
              passed, you can slo make a gift to Big Sisters in their memory.
              Loved ones or their family will receive a personalized note of the
              donation made in their honour and a tax receipt will be sent to you.
              Make a gift in honour of someone special online, call 604-873-4524 x321,
        ...
        <div class="donate-option">
          ...
          <div class="donate-option-description container">
            ...
            <p>
              ...
              like Big Sisters. In addition some employers will donate a specified
              amount to charities you volunteer for. By taking a few minutes to
              check with your HR department you might double the size of your
              gift!
            </p>
          </div>
        </div>
        ...
        <div class="donate-option">
          ...
          <div class="donate-option-description container">
            ...
            <p>
              ...
              have been that mentor. You can further this impact by making
              a bequest in your will that will provide others with mentors
              for years to come. Talk to your lawyer and family to advise
        ...
        <div class="donate-option">
          ...
          <div class="donate-option-description container">
            ...
            <p>
              ...
              This allows individuals to give away no-longer-wanted automobiles
              to charity organizations. This program collects and sells donated
              cars and distributes the money to the seller's designated charity -
        ...
        <div class="donate-option">
          ...
          <div class="donate-option-description container">
            ...
            Donate A Car Canada accepts Vehicle Donations for Big Sisters of BC
						Lower Mainland. We provide free towing in many areas across Canada,
						or you can drop off your vehicle to maximize your donation. When
						you donate your RV, boat, motorcycle or other vehicle to Big Sisters
						of BC Lower Mainland through Donate A Car Canada, it will either be
						recycled or sold at auction. Donate A Car Canada will look after
						all the details to make it easy for your Charity to benefit. After
						your Vehicle Donation is complete, Big Sisters of BC Lower Mainland
        ...
        <div class="donate-option">
          ...
          <div class="donate-option-description container">
            ...
            <p>
							...
							can give you great tax advantages while providing more Little
							Sisters with the gift of a mentor. For more information contact
							Treena Innes at 604-873-4525 x313. Download the Securities
							Donation Form.
            </p>
          </div>
        </div>
          ...
          <div class="donate-option-description container">
            ...
            <p>
              Contributions to our endowment fund (held with the Vancouver
							Foundation will provide stable funding to our organization on a
